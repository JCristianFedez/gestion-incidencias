...
>Tenga en cuenta que para eliminar un usuario antes debe de haberlo dado de baja, si quiere saber como hacerlo [pinche aqui](#Dar de baja a un usuario)

<br>

### Asignar un proyecto a un usuario de soporte
...
### Editar la asignacion de un proyecto a un usuario de Soporte
...
### Eliminar la asignacion de un proyecto a un usuario de Soporte
...
>Tenga en cuenta que para eliminar un proyecto antes debe de haberlo dado de baja, si quiere saber como hacerlo [pinche aqui](#Dar de baja un proyecto).
...
### Derivar incidencia al siguiente nivel
...
>Esta acción solo la puede realizar un administrador o el usuario que esta atendiendo la incidencia, para saber como atender una incidencia [pinche aqui](#Atender incidencia).