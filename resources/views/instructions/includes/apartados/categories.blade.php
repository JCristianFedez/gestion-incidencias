...
<section id="see-categories">
    <h4>Ver categorías de proyecto</h4>
    <p>
        Para ver las categorias que tiene un proyecto, debe de dirigirse en el menú izquierdo al apartado de
    ...
    <p>
        Se le redirigirá a una ventana en la cual en la parte inferior aparecerá una tabla con todas las categorías
        del proyecto seleccionado.
    </p>
</section>

<section id="create-category">
    <h4>Agregar categoria a proyecto</h4>
    <p>
    ...
    <p>
        Se le redirigirá a una ventana en la cual en la parte inferior aparecerá un campo de texto en el cual debe de
...
<section id="delete-category">
    ...
    <p class="text-muted">
        Tenga en cuenta que al eliminar una categoría todas las incidencias de dicha categoría pasaran a la categoría
        general.
    </p>
</section>