...
<section id="see-categories">
    ...
    <p>
        Se le redirigirá a una ventana en la cual en la <strong>parte inferior</strong> aparecerá una tabla con todas las categorías
...
<section id="create-category">
    ...
    <p>
        Se le redirigirá a una ventana en la cual en la <strong>parte inferior</strong> aparecerá un campo de texto en el cual debe de
