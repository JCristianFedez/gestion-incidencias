    ...
    <div class="card-body">
        ...
        <form action="/proyecto-usuario" method="POST" class="mb-3 row needs-validation" novalidate>
            ...
            <div class="col-md-4 form-group">
                <select name="project_id" class="form-control" id="select-project" aria-describedby="select-project-Feedback" required>
            ...
            <div class="col-md-4 form-group">
                <select name="level_id" class="form-control" id="select-level" aria-describedby="select-level-Feedback" required>
